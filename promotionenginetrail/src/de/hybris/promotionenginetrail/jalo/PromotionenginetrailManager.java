...
public class PromotionenginetrailManager extends GeneratedPromotionenginetrailManager
{
	...
	private static final Logger LOG = Logger.getLogger(PromotionenginetrailManager.class.getName());
	...
	{
		return (PromotionenginetrailManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PromotionenginetrailConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PromotionenginetrailManager called. " + getTenant().getTenantID());
		}
	}
