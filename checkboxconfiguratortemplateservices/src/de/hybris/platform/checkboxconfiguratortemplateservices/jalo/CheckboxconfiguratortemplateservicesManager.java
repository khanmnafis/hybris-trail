...
public class CheckboxconfiguratortemplateservicesManager extends GeneratedCheckboxconfiguratortemplateservicesManager
{
	...
	{
		return (CheckboxconfiguratortemplateservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CheckboxconfiguratortemplateservicesConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CheckboxconfiguratortemplateservicesManager called. " + getTenant().getTenantID());
		}
	}
